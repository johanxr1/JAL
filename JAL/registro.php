		...
		<div class="row">
			<div class="barra-lateral col-12 col-sm-auto">
				...
				<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
					<a href="#"><i class="icon-home"></i><span class="hidden-md-down">Inicio</span></a>
					<a href="#"><i class="icon-doc-text"></i><span class="hidden-md-down">Entradas</span></a>
					...
					<a href="#"><i class="icon-logout"></i><span class="hidden-md-down">Salir</span></a>
				</nav>
			</div>
			<!-- +Area de Mapa -->
						<main class="col">
