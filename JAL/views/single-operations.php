...
<!--   <div id="modal1" class="modal">
 ...
 -->
  <div class="flexbox-parent" >
    ...
    <div id="blaa" class="container" style="padding-top: 6rem;">
      <div class="info"></div>
      <div class="row comentarios">
        <div class="wrapper col s10">
          <form style="margin-top: 3rem;" action="" class="form_comentarios">
            <textarea name="" id="comentt" placeholder="Pregunta"></textarea>
            <button style="padding-left: 15px;" id="comentar" class="btn" type="button"><i class="material-icons left">edit</i>Preguntar</button>
          </form>
          <div id="preguntas">
  ...
  <script src="../controllers/singleOperations-controller.js"></script>
</body>
</html>
