...
<?php include('perfilbar.php');  ?>
      ...
      <div class="col s12 m8 l9">
								...
								<br>
                <p>Participación en eventos activos</p>
      ...
      <div class="col s12 m8 l9">
                ...
                <br>
                <p>Participación en eventos culminados</p>
                
              <ul id="listEvent1" class="collapsible col m10 s12 offset-m1" data-collapsible="accordion" style='padding: 0 !important;'>
