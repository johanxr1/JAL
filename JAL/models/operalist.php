...
//---------------------Informes--------------------
	$sql="SELECT mat,idp,fecha,des,speti,address,name,email,tlf FROM peticiones INNER JOIN users ON users.id=peticiones.ide where peticiones.ide = '$idusuario' OR peticiones.idr = '$idusuario'";
